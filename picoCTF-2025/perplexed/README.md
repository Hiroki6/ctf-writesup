...
I used Ghidra to reverse engineer the code.
The `check` function is the one that checks the flag.
```c
...
I just reversed the bit calculations in the for loop and got the flag.
```
$ python exploit.py
Generated flag: picoCTF{0n3_bi7_4t_a_7im3}
```
